...
<form name="form1" method="post" action="">
 <table width="200" border="1" align="center">
	...
	$i=0;
      $sel="SELECT * 
FROM tbl_plot p 
INNER JOIN tbl_place pl ON p.place_id = pl.place_id 
INNER JOIN tbl_district d ON d.district_id = pl.district_id 
INNER JOIN tbl_owner o ON p.owner_id = o.owner_id 
WHERE   p.place_id='".$_GET['did']."'";
	 $rows=$Con->query($sel);
    ...
    <tr>
      ...
      <td>
		...
		$average_rating = 0;
											...
											$query = "SELECT * FROM tbl_review where plot_id = '".$data["plot_id"]."' ORDER BY review_id DESC";
      ...
      <td><?php echo $data['bike_fee']?></td>
       <td><a href="Viewslots.php?pid=<?php echo $data['plot_id']?>">View Slots</a></td>
    </tr>
    <?php } ?>
  </table>
</form>
