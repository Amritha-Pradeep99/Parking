...
<html>
   <head>
      ...
      <!-- bootstrap css -->
      <link rel="stylesheet" type="text/css" href="Assets/Template/Main/css/bootstrap.min.css">
      <!-- style css -->
      ...
      <link rel="stylesheet" href="https://netdna.bootstrapcdn.com/font-awesome/4.0.3/Assets/Template/Main/css/font-awesome.css">
   </head>
   <body>
      ...
      <div class="header_section">
         <div class="container">
            ...
            <a class="navbar-brand" style="color: white; font-weight: bold; padding: 15px 20px;">
    E-Parking
</a>
               ...
               <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav ml-auto">
                     ...
                     <li class="nav-item">
                        <a class="nav-link" href="Guest/OwnerReg.php">Owner Registration</a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link" href="Guest/UserReg.php">User Registration</a>
                     </li>
                     <!-- <li class="nav-item">
      ...
      <div class="banner_section layout_padding">
         <div class="container">
            <div class="row">
                     ...
                     <div class="carousel-inner">
                        <div class="carousel-item active">
                           <div class="banner_taital_main">
                              <h1 class="banner_taital">Car And Bike <br><span style="color: #5A5A5A;">For You</span></h1>
                              <p class="banner_text"><span style="color: #FFFFFF;">A parking plot is a designated area for parking vehicles, typically marked with lines and signage for organization. It can vary from open lots to multi-level garages, providing safe and accessible parking options.</span></p>
                              <!-- <div class="btn_main">
               ...
               <div class="col-md-6">
                  <div class="banner_img"><img src="Assets/Template/Main/images/img-1.jpg"></div>
               </div>
            </div>
         </div>
      </div>
      ...
      <div class="about_section layout_padding">
         <div class="container">
            <div class="about_section_2">
               <div class="row">
                  <div class="col-md-6"> 
                     <div class="image_iman"><img src="Assets/Template/Main/images/img-3.png" class="about_img"></div>
                  </div>
                  <div class="col-md-6"> 
                     <div class="about_taital_box">
                        <h1 class="about_taital">About <span style="color: #5A5A5A;">Us</span></h1>
                        <p class="about_text">At E-Parking, we are dedicated to providing innovative solutions for sustainable transportation and parking. Our mission is to create accessible, safe, and environmentally friendly parking spaces for both cars and bikes. With a focus on community engagement and user experience, we strive to promote a greener lifestyle while enhancing urban mobility. Join us in our commitment 
                           to making our cities more sustainable and convenient for everyone! </p>
      ...
      <div class="gallery_section layout_padding">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <h1 class="gallery_taital">Parking Plots</h1>
               </div>
            </div>
               ...
               <div class="row">
                  <div class="col-md-4">
                     <div class="gallery_box">
                        <div class="gallery_img"><img src="Assets/Template/Main/images/p6.jpg"  width="300px" height="300px"></div>
                  ...
                  <div class="col-md-4">
                     <div class="gallery_box">
                        <div class="gallery_img"><img src="Assets/Template/Main/images/p4.jpg" width="300px" height="300px"></div>
                        <!-- <h3 class="types_text">Toyota car</h3>
                          <p class="looking_text">Start per day $4500</p>
                        <div class="read_bt"><a href="#">Book Now</a></div> -->
                     </div>
                  ...
                  <div class="col-md-4">
                     <div class="gallery_box">
                        <div class="gallery_img"><img src="Assets/Template/Main/images/p10.jpg"  width="300px" height="300px"></div>
                        <!-- <h3 class="types_text">Toyota car</h3>
                          <p class="looking_text">Start per day $4500</p>
                        <div class="read_bt"><a href="#">Book Now</a></div> -->
                     </div>
            ...
            <!-- <div class="gallery_section_2">
               <div class="row">
                  <div class="col-md-4">
                     <div class="gallery_box">
                        <div class="gallery_img"><img src="Assets/Template/Main/images/img-1.png"></div>
                        <h3 class="types_text">Toyota car</h3>
                          <p class="looking_text">Start per day $4500</p>
                        <div class="read_bt"><a href="#">Book Now</a></div> 
                     </div>
                  ...
                  <div class="col-md-4">
                     <div class="gallery_box">
                        <div class="gallery_img"><img src="Assets/Template/Main/images/img-2.png"></div>
                         <h3 class="types_text">Toyota car</h3>
                          <p class="looking_text">Start per day $4500</p>
                        <div class="read_bt"><a href="#">Book Now</a></div> 
                     </div>
                  ...
                  <div class="col-md-4">
                     <div class="gallery_box">
                        <div class="gallery_img"><img src="Assets/Template/Main/images/img-3.png"></div>
                        <h3 class="types_text">Toyota car</h3>
                          <p class="looking_text">Start per day $4500</p>
                        <div class="read_bt"><a href="#">Book Now</a></div>
                     </div>
      ...
      <!-- <div class="choose_section layout_padding">
         <div class="container">
            ...
            <div class="choose_section_2">
               <div class="row">
                  <div class="col-sm-4">
                     <div class="icon_1"><img src="Assets/Template/Main/images/icon-1.png"></div>
                  ...
                  <div class="col-sm-4">
                     <div class="icon_1"><img src="Assets/Template/Main/images/icon-2.png"></div>
                     <h4 class="safety_text">Online Booking</h4>
                     <p class="ipsum_text">variations of passages of Lorem Ipsum available, but the majority have </p>
                  </div>
                  <div class="col-sm-4">
                     <div class="icon_1"><img src="Assets/Template/Main/images/icon-3.png"></div>
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="client_taital_box">
                                 <div class="client_img"><img src="Assets/Template/Main/images/client-img1.png"></div>
                              ...
                              <div class="quick_icon"><img src="Assets/Template/Main/images/quick-icon.png"></div>
                           </div>
                           <div class="col-md-6">
                              <div class="client_taital_box">
                                 <div class="client_img"><img src="Assets/Template/Main/images/client-img2.png"></div>
      ...
      <div class="footer_section layout_padding">
         <div class="container">
            <!-- <div class="row">
               <div class="col-md-12">
               <a class="navbar-brand" style="color: white; font-weight: bold; padding: 15px 20px;" align="center">
    E-Parking
</a>
               </div> -->
            </div>
