        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    ...
                    <div class="ms-3">
                        <h6 class="mb-0"></h6>
                        <span style=" color:skyblue">Admin Dashboard</span>
                    </div>
                </div>
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="SlotType.php" class="dropdown-item">Slot Type</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Complaint</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="ViewComplaint.php" class="dropdown-item">View Complaint</a>
                            <a href="ViewComplaintReply.php" class="dropdown-item">View ComplaintReply</a>
                            <!-- <a href="SlotType.php" class="dropdown-item">Slot Type</a> -->
                        </div>
                    </div>
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toga-file-alt me-2"></i>Pages</a>
                        <div class="dropdown-menu bg-transparent border-0">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                            <!-- <a href="#" class="dropdown-item">gle="dropdown"><i class="far f
