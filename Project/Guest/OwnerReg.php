...
if(isset($_POST["btnsave"]))
{
	...
	$insQry="insert into tbl_owner(owner_name,owner_contact,owner_password,owner_email)values('".$name."','".$contact."','".$password."','".$email."')";
	//echo $insQry;	
  if($Con->query ($insQry))
			{
				?>
            ...
            <tr>
                ...
                <td>
                    <input type="password" name="txtrepassword" id="txtrepassword" 
                           required title="Please re-enter your password."/>
                </td>
            </tr>
            <tr>
                <td colspan="2">
