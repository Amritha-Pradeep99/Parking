    ...
    E-Parking
               ...
               <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav ml-auto">
                     ...
                     <li class="nav-item">
                        <a class="nav-link" href="SearchPlot.php">SearchPlot</a>
                     </li>
                     <li class="nav-item">
      ...
      <div class="banner_section layout_padding">
         <div class="container">
            <div class="row">
                     ...
                     <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                           <div class="banner_taital_main">
                              ...
                              <p class="banner_text"><span style="color: #FFFFFF;">A parking plot is a designated area for parking vehicles, typically marked with lines and signage for organization. It can vary from open lots to multi-level garages, providing safe and accessible parking options.</span></p>
                              <!-- <div class="btn_main">
                                 <div class="contact_bt"><a href="HomePage.php">Read More</a></div>
                                 <div class="contact_bt active"><a href="#">Contact Us</a></div> 
                              </div>  -->
                           </div>
                        </div>
               ...
               <div class="col-md-6">
                  <div class="banner_img"><img src="../Assets/Template/Main/images/banner-img.png"></div>
               </div>
            </div>
         </div>
      </div>
      ...
      <!-- <div class="about_section layout_padding">
         <div class="container">
            <div class="about_section_2">
               <div class="row">
                  <div class="col-md-6"> 
                     <div class="image_iman"><img src="../Assets/Template/Main/images/about-img.png" class="about_img"></div>
                  </div>
                  <div class="col-md-6"> 
      ...
      <!-- <div class="footer_section layout_padding">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="footeer_logo"><img src="../Assets/Template/Main/images/logo.png"></div>
               </div>
            </div>
